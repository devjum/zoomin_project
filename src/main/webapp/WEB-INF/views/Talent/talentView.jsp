...
<div id="view_top" class="wrapper">
        ...
        <div class="view_txt">
            ...
            <div class="v_btn">
                ...
                <form action="../Reserve/reserveWrite.do" method="post" onsubmit="return loginAlert();">
	...
	<script>
		function loginAlert() {
	    	if( ${ userInfo==null } ){
	    		alert("로그인 후에 예약진행 가능합니다");
	    		return false;
	    	} else if (${ userInfo != null} && ${userInfo.member == 'general'}){
	    		return true;
	    	} else if (${ userInfo != null} && ${ userInfo.member == 'artist'}){
	    		alert("재능예약은 일반회원으로 진행가능합니다.");
	    		return false;
	    	}
	    }
